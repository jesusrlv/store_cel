...
include('qconn/qc.php');
    ...
    $sql_catalogo = "SELECT * FROM producto WHERE catalogo ='$id_catalogo'";
    ...
    while($row_sql_catalogo = $resultado_sql_catalogo->fetch_assoc()){
        ...
        <div class="card text-center text-secondary bg-warning" style="width: 100%;">
          ...
          <div class="card-body">
            ...
            <hr>
            <button href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal'.$row_sql_catalogo['id'].'"><i class="bi bi-cart-plus"></i> Agregar al carrito</button>
          </div>
        </div>
      </div><!-- /.col-lg-4 -->';
